...
import com.mclear.classdroid.adapters.PupilAdapter;
...
public class SelectPupilActivity extends ClassdroidActivity implements OnItemClickListener,
    ...
    private void addPupil() {
        Intent intent = new Intent(SelectPupilActivity.this, AddPupilActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == TAKE_PICTURE) {
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, getString(R.string.lab_action_cancelled), Toast.LENGTH_LONG)
                        .show();
                finish();
            }
        } else if (requestCode == GRADE_ASSESSMENT) {
            if (resultCode == RESULT_OK) {
                Toast.makeText(SelectPupilActivity.this, getString(R.string.lab_upload_new),
            ...
            if (resultCode == RESULT_OK) {
                ...
                dbAdapter.close();
                Toast.makeText(SelectPupilActivity.this, getString(R.string.lab_new_pupil_added),
                        Toast.LENGTH_LONG).show();
                ...
                dbAdapter.close();
                Toast.makeText(SelectPupilActivity.this, getString(R.string.lab_action_cancelled),
                        Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long index) {
        ...
        if (checkServices()) {
            ...
            Toast.makeText(this, getString(R.string.lab_configure_settings), Toast.LENGTH_LONG)
                    .show();
            editAction();
        }
    }
    ...
    private void deleteAction() {
        ...
        dbAdapter.close();
        reloadListView();
        Toast.makeText(this, getString(R.string.lab_pupil_deleted), Toast.LENGTH_LONG).show();
    }

    private void editAction() {
        Intent intent = new Intent(SelectPupilActivity.this, EditPupilActivity.class);
    ...
    private boolean checkServices() {
        ...
        service = dbAdapter.getPupilServiceByPupilId(pupilId, PupilServices.TYPE_XPARENA);
        if (service.getIsEnabled() == PupilServices.SERVICE_ENABLED) {
            value = true;
        }
        dbAdapter.close();
